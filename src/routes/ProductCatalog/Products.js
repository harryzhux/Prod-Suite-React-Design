...
export default [
  {
    name: 'FlowTracer',
    shortname: 'ft',
    tag: 'Mission Critical Dependency Management',
    title: 'Advanced Platform for Developing and Executing Flows',
    desc: [
  ...
  {
    name: 'LicenseAllocator',
    shortname: 'la',
    tag: 'Multi-Site License Allocation and Management',
    title: 'Maximize License Usage Through Sharing',
    desc: [
  ...
  },
  {
    name: 'LicenseMonitor',
    shortname: 'lm',
    tag: 'Software License Monitoring and Management',
    title: 'Real-time license management and reporting',
    desc: [
  ...
  },
  {
    ...
    shortname: 'nc',
    tag: 'Industry’s Fastest Enterprise Job Scheduler',
    title: 'Event-driven Architecture for Highest Throughput',
    desc: [
  ...
  {
    name: 'WorkloadXelerator',
    shortname: 'wx',
    tag: 'High-Performance Hierarchical Scheduler',
    title: 'Offloading the Base Scheduler for Highest Throughput',
    desc: [
  ...
  },
  {
    name: 'HERO',
    shortname: 'he',
    tag: 'Hardware Emulation Resource Optimizer For Enterprise Job Scheduler',
    title: 'Industry’s Only End-to-End Emulation Solution',
    desc: [
